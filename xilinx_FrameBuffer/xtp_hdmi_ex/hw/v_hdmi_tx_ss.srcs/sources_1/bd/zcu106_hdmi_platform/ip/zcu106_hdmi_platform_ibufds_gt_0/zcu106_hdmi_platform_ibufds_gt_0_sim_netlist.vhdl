...
-- Date        : Sat Apr 20 16:38:59 2024
-- Host        : westlife running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/xilinx_prj/xilinx_FrameBuffer/xtp_hdmi_ex/hw/v_hdmi_tx_ss/v_hdmi_tx_ss.srcs/sources_1/bd/zcu106_hdmi_platform/ip/zcu106_hdmi_platform_ibufds_gt_0/zcu106_hdmi_platform_ibufds_gt_0_sim_netlist.vhdl
-- Design      : zcu106_hdmi_platform_ibufds_gt_0
...
entity zcu106_hdmi_platform_ibufds_gt_0_util_ds_buf is
  port (
  ...
  attribute C_BUF_TYPE of zcu106_hdmi_platform_ibufds_gt_0_util_ds_buf : entity is "ibufdsgte4";
  attribute C_SIZE : integer;
  attribute C_SIZE of zcu106_hdmi_platform_ibufds_gt_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zcu106_hdmi_platform_ibufds_gt_0_util_ds_buf : entity is "util_ds_buf";
end zcu106_hdmi_platform_ibufds_gt_0_util_ds_buf;

architecture STRUCTURE of zcu106_hdmi_platform_ibufds_gt_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zcu106_hdmi_platform_ibufds_gt_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of zcu106_hdmi_platform_ibufds_gt_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of zcu106_hdmi_platform_ibufds_gt_0 : entity is "zcu106_hdmi_platform_ibufds_gt_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of zcu106_hdmi_platform_ibufds_gt_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of zcu106_hdmi_platform_ibufds_gt_0 : entity is "util_ds_buf,Vivado 2018.1";
end zcu106_hdmi_platform_ibufds_gt_0;

architecture STRUCTURE of zcu106_hdmi_platform_ibufds_gt_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 156250000, CLK_DOMAIN zcu106_hdmi_platform_ibufds_gt_0_IBUF_DS_ODIV2";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 156250000, CLK_DOMAIN zcu106_hdmi_platform_ibufds_gt_0_IBUF_OUT";
begin
U0: entity work.zcu106_hdmi_platform_ibufds_gt_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
