...
//--------------------------------------------------------------------------------
//Command: generate_target bd_ceca.bd
//Design : bd_ceca
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_ceca,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_ceca,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "zcu106_hdmi_platform_v_hdmi_rx_ss_0_0.hwdef" *) 
module bd_ceca
   (AUDIO_OUT_tdata,
    AUDIO_OUT_tid,
    AUDIO_OUT_tready,
  ...
  bd_ceca_inverter_1_0 inverter_1
       (.Op1(net_bdry_in_cable_detect),
        .Res(net_inverter_1_Res));
  bd_ceca_v_hdmi_rx_0 v_hdmi_rx
  ...
  bd_ceca_v_vid_in_axi4s_0 v_vid_in_axi4s
