...
-- Date        : Sat Apr 20 16:38:57 2024
-- Host        : westlife running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/xilinx_prj/xilinx_FrameBuffer/xtp_hdmi_ex/hw/v_hdmi_tx_ss/v_hdmi_tx_ss.srcs/sources_1/bd/zcu106_hdmi_platform/ip/zcu106_hdmi_platform_clk_wiz_1_0/zcu106_hdmi_platform_clk_wiz_1_0_sim_netlist.vhdl
-- Design      : zcu106_hdmi_platform_clk_wiz_1_0
...
entity zcu106_hdmi_platform_clk_wiz_1_0_zcu106_hdmi_platform_clk_wiz_1_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of zcu106_hdmi_platform_clk_wiz_1_0_zcu106_hdmi_platform_clk_wiz_1_0_clk_wiz : entity is "zcu106_hdmi_platform_clk_wiz_1_0_clk_wiz";
end zcu106_hdmi_platform_clk_wiz_1_0_zcu106_hdmi_platform_clk_wiz_1_0_clk_wiz;

architecture STRUCTURE of zcu106_hdmi_platform_clk_wiz_1_0_zcu106_hdmi_platform_clk_wiz_1_0_clk_wiz is
  signal clk_in1_zcu106_hdmi_platform_clk_wiz_1_0 : STD_LOGIC;
  signal clk_out1_zcu106_hdmi_platform_clk_wiz_1_0 : STD_LOGIC;
  signal clk_out2_zcu106_hdmi_platform_clk_wiz_1_0 : STD_LOGIC;
  signal clk_out3_zcu106_hdmi_platform_clk_wiz_1_0 : STD_LOGIC;
  signal clkfbout_buf_zcu106_hdmi_platform_clk_wiz_1_0 : STD_LOGIC;
  signal clkfbout_zcu106_hdmi_platform_clk_wiz_1_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clkfbout_zcu106_hdmi_platform_clk_wiz_1_0,
      O => clkfbout_buf_zcu106_hdmi_platform_clk_wiz_1_0
    );
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_zcu106_hdmi_platform_clk_wiz_1_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out1_zcu106_hdmi_platform_clk_wiz_1_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out2_zcu106_hdmi_platform_clk_wiz_1_0,
      O => clk_out2
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out3_zcu106_hdmi_platform_clk_wiz_1_0,
      O => clk_out3
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 96.250000,
      ...
      CDDCREQ => '0',
      CLKFBIN => clkfbout_buf_zcu106_hdmi_platform_clk_wiz_1_0,
      CLKFBOUT => clkfbout_zcu106_hdmi_platform_clk_wiz_1_0,
      CLKFBOUTB => NLW_mmcme4_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcme4_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_zcu106_hdmi_platform_clk_wiz_1_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_zcu106_hdmi_platform_clk_wiz_1_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_zcu106_hdmi_platform_clk_wiz_1_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_out3_zcu106_hdmi_platform_clk_wiz_1_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zcu106_hdmi_platform_clk_wiz_1_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    clk_out3 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of zcu106_hdmi_platform_clk_wiz_1_0 : entity is true;
end zcu106_hdmi_platform_clk_wiz_1_0;

architecture STRUCTURE of zcu106_hdmi_platform_clk_wiz_1_0 is
begin
inst: entity work.zcu106_hdmi_platform_clk_wiz_1_0_zcu106_hdmi_platform_clk_wiz_1_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
