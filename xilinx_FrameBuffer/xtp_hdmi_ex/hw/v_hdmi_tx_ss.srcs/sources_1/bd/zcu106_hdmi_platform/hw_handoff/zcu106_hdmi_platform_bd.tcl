...
################################################################
# This is a generated script based on design: zcu106_hdmi_platform
#
...
# source zcu106_hdmi_platform_script.tcl
...
set design_name zcu106_hdmi_platform
...
proc create_hier_cell_tpg_input { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 0 -to 0 -type clk clk_vtc
  create_bd_pin -dir I hdmi_tx_clk
  ...
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins tpg_0_VTP_reset/Din] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net clk_50mhz [get_bd_pins s_axi_aclk] [get_bd_pins v_tc_1/s_axi_aclk]
  connect_bd_net -net fmc_hdmi_input_clk_out [get_bd_pins clk_vtc] [get_bd_pins v_tc_1/clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
...
proc create_hier_cell_mpsoc_ss { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 0 -to 0 -type intr pl_ps_irq1
...
proc create_hier_cell_hdmi_output { parentCell nameHier } {
  ...
  set v_frmbuf_rd_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_frmbuf_rd:2.0 v_frmbuf_rd_0 ]
  set_property -dict [ list \
...
proc create_hier_cell_hdmi_input { parentCell nameHier } {
  ...
  connect_bd_net -net rx_scaler_reset [get_bd_pins frmbuf_aresetn] [get_bd_pins v_proc_ss_0/aresetn_ctrl]
  connect_bd_net -net v_frmbuf_wr_0_interrupt [get_bd_pins interrupt] [get_bd_pins v_frmbuf_wr_0/interrupt]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_interconnect_4/S01_AXI] [get_bd_intf_pins tpg_input/m_axi_mm_video]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets SB_STATUS_IN_1] [get_bd_intf_pins hdmi_output/SB_STATUS] [get_bd_intf_pins tx_hdmi_hb_0/status_sb]
  ...
  connect_bd_intf_net -intf_net mpsoc_ss_M09_AXI_0 [get_bd_intf_pins mpsoc_ss/M09_AXI_0] [get_bd_intf_pins tpg_input/s_axi_frm_wr]
  connect_bd_intf_net -intf_net mpsoc_ss_M10_AXI_0 [get_bd_intf_pins mpsoc_ss/M10_AXI_0] [get_bd_intf_pins tpg_input/s_axi_tpg]
  connect_bd_intf_net -intf_net mpsoc_ss_M11_AXI_0 [get_bd_intf_pins mpsoc_ss/M11_AXI_0] [get_bd_intf_pins tpg_input/s_axi_vtc]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets vid_phy_controller_vid_phy_status_sb_rx] [get_bd_intf_pins hdmi_input/SB_STATUS] [get_bd_intf_pins rx_hdmi_hb_0/status_sb]
  ...
  connect_bd_net -net aresetn_100M [get_bd_ports SI5319_RST] [get_bd_pins hdmi_input/aresetn_100M] [get_bd_pins hdmi_output/aresetn_100M] [get_bd_pins mpsoc_ss/aresetn_100M] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aresetn] [get_bd_pins vid_phy_controller/vid_phy_sb_aresetn]
  connect_bd_net -net clk_100M [get_bd_pins hdmi_input/clk_100M] [get_bd_pins hdmi_output/clk_100M] [get_bd_pins mpsoc_ss/clk_100M] [get_bd_pins rx_hdmi_hb_0/status_sb_aclk] [get_bd_pins tpg_input/s_axi_aclk] [get_bd_pins tx_hdmi_hb_0/status_sb_aclk] [get_bd_pins vcu_0/s_axi_lite_aclk] [get_bd_pins vid_phy_controller/drpclk] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aclk] [get_bd_pins vid_phy_controller/vid_phy_sb_aclk]
  ...
  connect_bd_net -net gpio [get_bd_pins gpio_aresetn/Din] [get_bd_pins hdmi_input/Din] [get_bd_pins hdmi_output/Din] [get_bd_pins mpsoc_ss/gpio] [get_bd_pins tpg_input/Din]
  ...
  connect_bd_net -net mpsoc_ss_pl_resetn0_0 [get_bd_pins mpsoc_ss/pl_resetn0_0] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins vcu_0/vcu_resetn]
  connect_bd_net -net net_vid_phy_controller_tx_video_clk [get_bd_pins hdmi_output/video_clk] [get_bd_pins tpg_input/hdmi_tx_clk] [get_bd_pins vid_phy_controller/tx_video_clk]
  connect_bd_net -net pl_ps_irq1_1 [get_bd_pins interrupts1/dout] [get_bd_pins mpsoc_ss/pl_ps_irq1]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_0/S04_ARESETN] [get_bd_pins axi_interconnect_0/S05_ARESETN] [get_bd_pins axi_interconnect_0/S06_ARESETN] [get_bd_pins axi_interconnect_0/S07_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_2/S01_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins axi_interconnect_4/S01_ARESETN] [get_bd_pins hdmi_input/aresetn_300M] [get_bd_pins hdmi_output/aresetn_300M] [get_bd_pins mpsoc_ss/reset_333] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins tpg_input/tpg_rst_n]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA00C0000 [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tpg_input/v_frmbuf_wr_0/s_axi_CTRL/Reg] SEG_v_frmbuf_wr_0_Reg2
