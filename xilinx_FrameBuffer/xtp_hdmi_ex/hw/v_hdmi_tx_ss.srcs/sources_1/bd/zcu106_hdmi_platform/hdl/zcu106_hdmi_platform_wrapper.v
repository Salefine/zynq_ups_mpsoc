...
//Date        : Sat Apr 20 16:29:39 2024
//Host        : westlife running 64-bit major release  (build 9200)
//Command     : generate_target zcu106_hdmi_platform_wrapper.bd
//Design      : zcu106_hdmi_platform_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module zcu106_hdmi_platform_wrapper
   (DRU_CLK_clk_n,
    DRU_CLK_clk_p,
  ...
  IOBUF TX_DDC_sda_iobuf
       (.I(TX_DDC_sda_o),
        ...
        .O(TX_DDC_sda_i),
        .T(TX_DDC_sda_t));
  zcu106_hdmi_platform zcu106_hdmi_platform_i
