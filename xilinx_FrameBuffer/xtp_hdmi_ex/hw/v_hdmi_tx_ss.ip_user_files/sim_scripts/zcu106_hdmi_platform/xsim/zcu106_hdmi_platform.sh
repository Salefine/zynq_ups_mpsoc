...
xvlog_opts="--relax -L smartconnect_v1_0 -L axi_protocol_checker_v2_0_2 -L axi_vip_v1_1_2 -L zynq_ultra_ps_e_vip_v1_0_2 -L vid_phy_controller_v2_2_0 -L xil_defaultlib -L v_hdmi_tx_v3_0_0 -L v_hdmi_rx_v3_0_0 -L xilinx_vip"
xvhdl_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="D:/tools/xilinx/Vivado/2018.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb zcu106_hdmi_platform.wdb xsim.dir)
