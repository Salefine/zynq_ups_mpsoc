...
HD_PWD='D:/xilinx_prj/xilinx_FrameBuffer/xtp_hdmi_ex/hw/v_hdmi_tx_ss/v_hdmi_tx_ss.runs/zcu106_hdmi_platform_auto_cc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zcu106_hdmi_platform_auto_cc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zcu106_hdmi_platform_auto_cc_2.tcl
