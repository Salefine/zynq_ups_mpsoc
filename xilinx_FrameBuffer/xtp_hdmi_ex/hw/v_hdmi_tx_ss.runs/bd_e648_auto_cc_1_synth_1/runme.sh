...
HD_PWD='D:/xilinx_prj/xilinx_FrameBuffer/xtp_hdmi_ex/hw/v_hdmi_tx_ss/v_hdmi_tx_ss.runs/bd_e648_auto_cc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_e648_auto_cc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_e648_auto_cc_1.tcl
