...
HD_PWD='D:/xilinx_prj/xilinx_FrameBuffer/xtp_hdmi_ex/hw/v_hdmi_tx_ss/v_hdmi_tx_ss.runs/bd_6ee1_v_tc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_6ee1_v_tc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_6ee1_v_tc_0.tcl
